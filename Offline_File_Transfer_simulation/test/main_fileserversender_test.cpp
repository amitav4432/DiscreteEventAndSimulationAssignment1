...
int main(int argc, char ** argv) {
    ...
    if (argc < 3) {
        ...
        cout << argv[0] << " path to the filseserversender_request_input fileserversender_dataIn_test fileserversender_ackIn_test txt files " << endl;
        return 1; 
    }

    /****** Input Reader atomic model instantiation *******************/
    const char * i_input_data = argv[1]; //"../input_data/fileserversender_requestIn.txt";
    ...
    const char * i_input_dataIn = argv[2]; //"../input_data/fileserversender_dataIn_test.txt";
    ...
    const char * i_input_ackIn = argv[3]; //"../input_data/fileserversender_ackIn_test.txt";
